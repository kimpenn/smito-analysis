...
pdf("Report/strains/clustalo-17strains.pdf")
...
ggsave(fig, filename= "Report/strains/smito_all_vs_17strains-inrange_venn.pdf", width = 6, height = 6)
...
smito_strains_overlap <- fread(file = "Report/strains/smito_17strains-inrange_overlap.csv")

pdf(file = "Report/strains/smito_17strains-inrange_overlap_barplot.pdf", height = 6, width = 6)
...
smito_evo17strains_avgaf <- fread(file = "Report/strains/smito_17strains_avgaf.csv")
