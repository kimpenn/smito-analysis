...
dir.create("Report/release/SNVs/filter", FALSE, TRUE)

snv_info <- fread("Data/snv_loci_v2.csv")
snvIDs <- snv_info[, SNVID]

chrmproperties <- fread("Report/release/artifact/chrmbases_properties.csv.gz")
...
basedifffreq_end_q30_bysnv <- fread(file = "Report/release/artifact/basedifffreq_end_q30_bysnv.csv.gz")
...
fwrite(basedifffreq_cutdemux_q30_unstranded, file = "Report/release/SNVs/basedifffreq_cutdemux_sub500k_q30_unstranded_9027fixed.csv.gz")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth.csv.gz")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_highaf, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf.csv.gz")
basediffperc_cutdemux_q30_unstranded_highdepth_highaf <- fread("Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf.csv.gz")
...
###########################################################################
pos_noctrl_starvsbwa <- fread("Report/release/bwa/snv_pos_noctrl.csv")
...
## [1] 838
fwrite(pos_noctrl_qc, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qc.csv")
pos_noctrl_qc <- fread(file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qc.csv")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_highaf_qcfltd, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qcfltd.csv.gz")
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_qcfltd <- fread("Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qcfltd.csv.gz")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_highaf_qcfltd_support, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qcfltd_support_byposmut.csv")
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_qcfltd_support_byposmut <- fread(file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qcfltd_support_byposmut.csv")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_highaf_qcfltd_support, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qcfltd_support_bypos.csv")
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_qcfltd_support_bypos <- fread(file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_highaf_qcfltd_support_bypos.csv")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_qcfltd, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_qcfltd.csv.gz")
basediffperc_cutdemux_q30_unstranded_highdepth_qcfltd <- fread(file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_qcfltd.csv.gz")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_qcfltd_altperc_bymito_byposmut, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_qcfltd_altperc_bymito_byposmut.csv.gz")
basediffperc_cutdemux_q30_unstranded_highdepth_qcfltd_altperc_bymito_byposmut <- fread(file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_qcfltd_altperc_bymito_byposmut.csv.gz")
...
fwrite(basediffperc_cutdemux_q30_unstranded_highdepth_qcfltd_allele_bymito_bypos, file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_qcfltd_allele_bymito_bypos.csv.gz")
basediffperc_cutdemux_q30_unstranded_highdepth_qcfltd_allele_bymito_bypos <- fread(file = "Report/release/SNVs/filter/basediffperc_cutdemux_sub500k_q30_unstranded_highdepth_qcfltd_allele_bymito_bypos.csv.gz")
...
fwrite(basedifffreq_cutdemux_q30_unstranded_qcfltd_depth_bymito_bypos, file = "Report/release/SNVs/filter/basedifffreq_cutdemux_sub500k_q30_unstranded_qcfltd_depth_bymito_bypos.csv.gz")
basedifffreq_cutdemux_q30_unstranded_qcfltd_depth_bymito_bypos <- fread(file = "Report/release/SNVs/filter/basedifffreq_cutdemux_sub500k_q30_unstranded_qcfltd_depth_bymito_bypos.csv.gz", header = TRUE)
...
mpileups_ins_cutdemux <- read.csv("Report/release/SNVs/ins/mpileups_ins_cutdemux_sub500k.csv.gz", as.is = TRUE, check.names = FALSE)
...
fwrite(mpileups_ins_cutdemux_highdepth_highaf, file = "Report/release/SNVs/filter/mpileups_ins_cutdemux_sub500k_highdepth_highaf.csv.gz", na = "NA")
mpileups_ins_cutdemux_highdepth_highaf <- fread("Report/release/SNVs/filter/mpileups_ins_cutdemux_sub500k_highdepth_highaf.csv.gz")
...
fwrite(mpileups_ins_cutdemux_highdepth_highaf_qcfltd, file = "Report/release/SNVs/filter/mpileups_ins_cutdemux_sub500k_highdepth_highaf_qcfltd.csv.gz")
