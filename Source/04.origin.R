...
pdf("Report/SNVs/origin/highdepth_highaf_noctrl_nposmut_bynmice_obs-vs-null.pdf", width = 6, height = 6)
...
highdepth_inherited <- fread(file = "Report/SNVs/origin/highdepth_inherited.csv.gz")
...
highdepth_inherited_altperc_bymito_byposmut <- fread(file = "Report/SNVs/origin/highdepth_inherited_altperc_bymito_byposmut.csv.gz")
...
highdepth_inherited_allele_bymito_bypos <- fread(file = "Report/SNVs/origin/highdepth_inherited_allele_bymito_bypos.csv.gz")
...
pdf("Report/SNVs/origin/highdepth_inherited_noctrl_altperc_bymito_byposmut_heatmap.pdf", width = 16, height = 8)
...
highdepth_somatic <- fread(file = "Report/SNVs/origin/highdepth_somatic.csv.gz")
...
highdepth_somatic_altperc_bymito_byposmut <- fread(file = "Report/SNVs/origin/highdepth_somatic_altperc_bymito_byposmut.csv.gz")
...
highdepth_somatic_allele_bymito_bypos <- fread(file = "Report/SNVs/origin/highdepth_somatic_allele_bymito_bypos.csv.gz")
...
MitoInfo_df$CellID <- as.integer(MitoInfo_df$CellID)
MitoInfo_df$MouseID <- factor(MitoInfo_df$MouseID, levels = sort(MouseInfo[, MouseID]))
pdf("Report/SNVs/origin/highdepth_somatic_noctrl_altperc_bymito_byposmut_heatmap.pdf", width = 16, height = 8)
...
highdepth_inherited_noctrl_hasdata_bymito_bypos <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_hasdata_bymito_bypos.csv", header = TRUE)
...
highdepth_inherited_noctrl_hasdata_bycell_bypos <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_hasdata_bycell_bypos.csv", header = TRUE)
...
highdepth_inherited_noctrl_hasdata_bymouse_bypos <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_hasdata_bymouse_bypos.csv", header = TRUE)
...
highdepth_inherited_noctrl_nmitoshasdata_bycell_bypos <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_nmitoshasdata_bycell_bypos.csv", header = TRUE)
...
highdepth_inherited_noctrl_ncellshasdata_bymouse_bypos <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_ncellshasdata_bymouse_bypos.csv", header = TRUE)
...
highdepth_highaf_inherited_noctrl_nvaralleles_bymito_bypos <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nvaralleles_bymito_bypos.csv", header = TRUE)
...
highdepth_highaf_inherited_noctrl_nvaralleles_bycell_bypos <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nvaralleles_bycell_bypos.csv", header = TRUE)
...
highdepth_highaf_inherited_noctrl_nvaralleles_bymouse_bypos <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nvaralleles_bymouse_bypos.csv", header = TRUE)
...
pdf("Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nvaralleles_bymito_bypos_heatmap.pdf", width = 16, height = 7)
...
pdf("Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nvaralleles_bycell_bypos_heatmap.pdf", width = 16, height = 4.5)
...
pdf("Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nvaralleles_bymouse_bypos_heatmap.pdf", width = 16, height = 2)
...
highdepth_somatic_noctrl_hasdata_bymito_bypos <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_hasdata_bymito_bypos.csv", header = TRUE)
...
highdepth_somatic_noctrl_hasdata_bycell_bypos <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_hasdata_bycell_bypos.csv", header = TRUE)
...
highdepth_somatic_noctrl_hasdata_bymouse_bypos <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_hasdata_bymouse_bypos.csv", header = TRUE)
...
highdepth_somatic_noctrl_nmitoshasdata_bycell_bypos <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_nmitoshasdata_bycell_bypos.csv", header = TRUE)
...
highdepth_somatic_noctrl_ncellshasdata_bymouse_bypos <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_ncellshasdata_bymouse_bypos.csv", header = TRUE)
...
highdepth_highaf_somatic_noctrl_nvaralleles_bymito_bypos <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nvaralleles_bymito_bypos.csv", header = TRUE)
...
highdepth_highaf_somatic_noctrl_nvaralleles_bycell_bypos <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nvaralleles_bycell_bypos.csv", header = TRUE)
...
highdepth_highaf_somatic_noctrl_nvaralleles_bymouse_bypos <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nvaralleles_bymouse_bypos.csv", header = TRUE)
...
pdf("Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nvaralleles_bymito_bypos_heatmap.pdf", width = 16, height = 7)
...
pdf("Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nvaralleles_bycell_bypos_heatmap.pdf", width = 16, height = 4.5)
...
pdf("Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nvaralleles_bymouse_bypos_heatmap.pdf", width = 16, height = 2)
...
highdepth_inherited_noctrl_nmitoshasdata_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_nmitoshasdata_bycell_byposmut.csv")
...
highdepth_inherited_noctrl_ncellshasdata_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_inherited_noctrl_ncellshasdata_bymouse_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_hassnv_bymito_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_hassnv_bymito_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_hassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_hassnv_bycell_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_hassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_hassnv_bymouse_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_nmitoshassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_nmitoshassnv_bycell_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_ncellshassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_ncellshassnv_bymouse_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_fmitoshassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_fmitoshassnv_bycell_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_fcellshassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_fcellshassnv_bymouse_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_fmitoshasdatahassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_fmitoshasdatahassnv_bycell_byposmut.csv")
...
highdepth_highaf_inherited_noctrl_fcellshasdatahassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_inherited_noctrl_fcellshasdatahassnv_bymouse_byposmut.csv")
...
highdepth_somatic_noctrl_nmitoshasdata_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_nmitoshasdata_bycell_byposmut.csv")
...
highdepth_somatic_noctrl_ncellshasdata_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_somatic_noctrl_ncellshasdata_bymouse_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_hassnv_bymito_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_hassnv_bymito_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_hassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_hassnv_bycell_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_hassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_hassnv_bymouse_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_nmitoshassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_nmitoshassnv_bycell_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_ncellshassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_ncellshassnv_bymouse_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_fmitoshassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_fmitoshassnv_bycell_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_fcellshassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_fcellshassnv_bymouse_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_fmitoshasdatahassnv_bycell_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_fmitoshasdatahassnv_bycell_byposmut.csv")
...
highdepth_highaf_somatic_noctrl_fcellshasdatahassnv_bymouse_byposmut <- fread(file = "Report/SNVs/origin/highdepth_highaf_somatic_noctrl_fcellshasdatahassnv_bymouse_byposmut.csv")
