...
if (!exists("Graphics") || is.environment(Graphics)) Graphics <- new.env(parent = emptyenv())
local({
    .VERSION = "0.4"

    ## From https://sashamaps.net/docs/resources/20-colors/
    palette20 <- c( '#e6194b', '#3cb44b', '#ffe119', '#4363d8', '#f58231', '#911eb4', '#46f0f0', '#f032e6', '#bcf60c', '#fabebe', '#008080', '#e6beff', '#9a6324', '#fffac8', '#800000', '#aaffc3', '#808000', '#ffd8b1', '#000075', '#808080', '#ffffff', '#000000')

    for (obj in ls()) { assign(obj, get(obj), envir = Graphics) }
})
