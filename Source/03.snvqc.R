...
pdf("Report/SNVs/QC/nbases_highdepth_heatmap.pdf", height = 9, width = 9)
...
basedifffreq_cutdemux_q30_unstranded_avgdepth <- fread(file = "Report/SNVs/QC/avgdepth_byCtrlType.csv.gz")
...
ggsave(figs, file = "Report/SNVs/QC/avgdepth_byCtrlType_boxplot.pdf", width = 12, height = 7)


png("Report/SNVs/QC/depth_bypos_colorbymito.png", width = 300 * 1 * length(snvIDs), height = 300 * 1 * length(mitoIDs), res = 300, type = "cairo")
...
basedifffreq_cutdemux_q30_unstranded_depthstats <- fread("Report/SNVs/QC/depthstats.csv.gz")
...
basedifffreq_cutdemux_q30_unstranded_highdepthstats <- fread("Report/SNVs/QC/highdepthstats.csv.gz")
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_nposhasdata_bymito <- fread(file = "Report/SNVs/QC/highdepth_noctrl_nposhasdata_bymito.csv")
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_nposhasdata_bycell <- fread(file = "Report/SNVs/QC/highdepth_noctrl_nposhasdata_bycell.csv")
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_nposhasdata_bymouse <- fread(file = "Report/SNVs/QC/highdepth_noctrl_nposhasdata_bymouse.csv")
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_nsampleshasdata_bypos <- fread(file = "Report/SNVs/QC/highdepth_noctrl_nsampleshasdata_bypos.csv", header = TRUE)

pdf("Report/SNVs/QC/highdepth_noctrl_nsampleshasdata_bypos_barplot.pdf", width = 12, height = 4)
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_nmitoshasdata_bycell_bypos <- fread(file = "Report/SNVs/QC/highdepth_noctrl_nmitoshasdata_bycell_bypos.csv", header = TRUE)
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_ncellshasdata_bymouse_bypos <- fread(file = "Report/SNVs/QC/highdepth_noctrl_ncellshasdata_bymouse_bypos.csv", header = TRUE)
...
pdf("Report/SNVs/QC/highdepth_noctrl_nmitoshasdata_bycell_byposmut_pheatmap.pdf", width = 18, height = 7)
...
pdf("Report/SNVs/QC/highdepth_noctrl_ncellshasdata_bymouse_byposmut_pheatmap.pdf", width = 18, height = 2)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_vaf_hist.pdf", width = 6, height = 6)
...
ggsave(fig, filename = "Report/SNVs/QC/highdepth_highaf_noctrl_hassnv_per_pos_per_mito.pdf", width = 10, height = 4)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_support_circos.pdf", height = 7, width = 7)
circos.clear()
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_npos_bymito <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_npos_bymito.csv")
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_npos_bycell <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_npos_bycell.csv")
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_npos_bymouse <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_npos_bymouse.csv")
...
ggsave(fig, filename = "Report/SNVs/QC/highdepth_highaf_noctrl_npos_bycell_boxplot.pdf", width = 12, height = 6)
...
basediffperc_cutdemux_q30_unstranded_highdepth_noctrl_nsampleshasdata_byposmut <- fread(file = "Report/SNVs/QC/highdepth_noctrl_nsampleshasdata_byposmut.csv", header = TRUE)
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_nmitoshassnv_bycell_byposmut <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_nmitoshassnv_bycell_byposmut.csv.gz")
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_ncellshassnv_bymouse_byposmut <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_ncellshassnv_bymouse_byposmut.csv.gz")
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_nmitoshassnv_bycell_byposmut_pheatmap.pdf", width = 15, height = 7)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_ncellshassnv_bymouse_byposmut_pheatmap.pdf", width = 15, height = 2)
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_nsamples_byposmut <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_nsamples_byposmut.csv")
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_nvaralleles_bymito_bypos <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_nvaralleles_bymito_bypos.csv", header = TRUE)
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_nvaralleles_bycell_bypos <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_nvaralleles_bycell_bypos.csv", header = TRUE)
...
basediffperc_cutdemux_q30_unstranded_highdepth_highaf_noctrl_nvaralleles_bymouse_bypos <- fread(file = "Report/SNVs/QC/highdepth_highaf_noctrl_nvaralleles_bymouse_bypos.csv", header = TRUE)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_nvaralleles_bymito_bypos_heatmap.pdf", width = 12, height = 7)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_nvaralleles_bycell_bypos_heatmap.pdf", width = 12, height = 4.5)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_nvaralleles_bymouse_bypos_heatmap.pdf", width = 12, height = 2)
...
pdf("Report/SNVs/QC/highdepth_noctrl_avgvaf_support_byposmut_boxplot.pdf", width = 6, height = 6)
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_nposmut_bysupport.pdf", width = 6, height = 6)
par(ps = 16, lend = 2, ljoin = 1, bty = "L", mfrow = c(1, 1), mar = c(2.5, 2.5, 0.5, 0.5), oma = c(0, 0, 0, 0), mgp = c(1.5, 0.5, 0))
...
pdf("Report/SNVs/QC/highdepth_highaf_noctrl_support_bynvaralleles.pdf", width = 6, height = 6)
